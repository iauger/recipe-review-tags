...
def build_features_with_full_corpus_w2v(
    ...
    *,
    ...
    print(f"Loaded labeled_df with {labeled_df.count()} rows")
    print(f"Loaded full_corpus_df with {full_corpus_df.count()} rows")
    ...
    print(f"Full corpus tokens after filtering: {full_tokens_filtered.count()} rows")
    
    full_tokens_filtered = full_tokens_filtered.repartition(200) 
